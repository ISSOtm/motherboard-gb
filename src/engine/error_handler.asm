...
CutsceneCommandError::
    handle_error ERROR_CUTSCENE_COMMAND
TextStackOverflowError::
    handle_error ERROR_TEXT_STACK_OVERFLOW
TextCtrlCharError::
...
SendNudesStr:
    ...
    ; May not be longer than 19 chars
ErrorStrings:
    dw .hlJumpErrorStr
    dw .deJumpErrorStr
    dw .nullExecErrorStr
...
.rst38ErrorStr
    dstr "rst 38 error"
.cutsceneErrorStr
    dstr "Bad cutscene comm"
.textStackOverflowStr
    dstr "Text stack overflow"
.badCtrlCharStr
    dstr "Bad ctrl char"
.RPNExpressionError
...
ErrorSGBLayout: ; Set entire screen to palette 0
    sgb_packet ATTR_BLK, 1, 1
    db %001, 0, 0, 0, 19, 17

ErrorSGBPal:
    sgb_packet PAL01, 1
    dw $7FFF, 0, 0, 0
    ; Second palette not defined because we don't care
